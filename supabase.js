...
class SimpleSupabaseClient {
    ...
    getDefaultPhotos() {
        return [
            ...
            { id: '2', title: '老街记忆', category: 'film', year: 2023, description: '胶片记录的老街风情', thumbnail_url: 'https://images.unsplash.com/photo-1519111887837-a48ccf9edc00', image_url: 'https://images.unsplash.com/photo-1519111887837-a48ccf9edc00', is_active: true, sort_order: 2, attributes: { size: '40x50', negative_size: '120', other: '限量10张' } },
            { id: '3', title: '静物之美', category: 'wetplate', year: 2024, description: '湿版摄影的独特质感', thumbnail_url: 'https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85', image_url: 'https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85', is_active: true, sort_order: 3, attributes: { size: '20x25', negative_size: '8x10英寸', other: '古典工艺' } },
            ...
            { id: '5', title: '植物蓝图', category: 'cyanotype', year: 2024, description: '蓝晒工艺的自然创作', thumbnail_url: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b', image_url: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b', is_active: true, sort_order: 5, attributes: { size: '30x40', negative_size: '', other: '植物标本' } },
            { id: '6', title: '肖像习作', category: 'vandyke', year: 2023, description: '范戴克棕的人像表现', thumbnail_url: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04', image_url: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04', is_active: true, sort_order: 6, attributes: { size: '25x30', negative_size: '8x10英寸', other: '手工制作' } },
            { id: '7', title: '夜色都市', category: 'digital', year: 2024, description: '数码摄影的夜景表现', thumbnail_url: 'https://images.unsplash.com/photo-1519501025264-65ba15a82390', image_url: 'https://images.unsplash.com/photo-1519501025264-65ba15a82390', is_active: true, sort_order: 7, attributes: { size: '60x90', negative_size: '全画幅', other: '长曝光' } },
            { id: '8', title: '海浪瞬间', category: 'film', year: 2023, description: '胶片捕捉的海浪瞬间', thumbnail_url: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0', image_url: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0', is_active: true, sort_order: 8, attributes: { size: '40x50', negative_size: '120', other: '' } }
        ];
    }
